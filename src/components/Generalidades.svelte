<script>
    ...
    const { form, errors, handleChange, handleSubmit } = createForm({
        initialValues: {
            ...
            cargoInfraestructura: '',
            nombreCiberseguridad: '',
            cargoCiberseguridad: '',
            nombreDesarrolloNC: '',
            cargoDesarrolloNC: '',
            nombreDesarrollo: '',
      ...
      onSubmit: async () => {
        ...
        try {
          ...
          const response = await postData('/generalidades', $form);
          console.log("Formulario de Generalidades enviado correctamente:", response);
          ...
          console.error("Error al enviar el formulario de Generalidades:", error);
        }
      }
    });
    ...
    async function fetchData() {
        try {
            const data = await getData('/generalidades'); 
            receivedData = data;
